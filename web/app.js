  ...
  const I18N = {
    en: {
      ...
      guide: {
        ...
        preset1_copy:
          "SVG / Reasoning Provider: OpenAI Responses. Step 1 Image Provider: Same as SVG path. Image Model: gpt-image-2. SVG Model: gpt-5.6-terra.",
        ...
        field_svg_model_copy:
          "Default follows the selected reasoning route. The default for OpenAI Responses is gpt-5.6-terra, while Gemini/OpenRouter/Custom use the Gemini defaults unless you know you need a different id.",
        ...
        example1_copy:
          "Main page. Provider = OpenAI Responses. Image Provider = Same as SVG path. Image Model = gpt-image-2. SVG Model = gpt-5.6-terra. Fill one API key.",
    ...
    zh: {
      ...
      guide: {
        ...
        preset1_copy:
          "SVG / 推理 Provider 选 OpenAI Responses，步骤 1 图片 Provider 保持与 SVG 路径一致，Image Model 用 gpt-image-2，SVG Model 用 gpt-5.6-terra。",
        ...
        field_svg_model_copy:
          "默认会跟随当前推理路线。OpenAI Responses 默认是 gpt-5.6-terra；Gemini/OpenRouter/Custom 默认沿用 Gemini 系列模型，除非你明确知道要改。",
        ...
        example1_copy:
          "主页面。Provider 选 OpenAI Responses，Image Provider 保持与 SVG 路径一致，Image Model 用 gpt-image-2，SVG Model 用 gpt-5.6-terra，只填一套 API Key。",
